            ...
            {showModal ? 
                <div className="fixed inset-0 bg-slate-700/30 flex justify-center items-center z-50 transition-all duration-200 ease-in-out">
                    <div className="max-h-[calc(100vh - 5em)] h-fit w-2/3 scale-90
                            overscroll-contain rounded-3xl bg-lightred p-6 text-black shadow-2xl transition">
                            <div className="mx-8 my-5">
                                <div className="h-fit w-fit bg-red-200 hover:bg-logored/55 rounded-full p-2 absolute top-8 right-12"
