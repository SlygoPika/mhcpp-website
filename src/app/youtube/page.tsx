...
import VideoCarousel from "../components/subviews/youtube/VideoCarousel";
  ...
  useEffect(() => {
    ...
    return (
      ...
      <h1 id="level1" className=" text-center pb-6 text-3xl text-logored font-semibold">
        {allHeadings[userLang == "en" ? "en" : "fr"]["level1"]}
      </h1>
      <p>
        {allText[userLang == "en" ? "en" : "fr"]["level1Text"]}
      </p>
      <div className="mt-5">
      <Switch className="h-full w-full checked:bg-logored"
        ...
        label={userLang == "en" ? "French" : "Anglais"} crossOrigin={undefined} onClick={() => setLevelLang({
      ...
      <h1 id="level2" className=" text-center pb-6 text-3xl text-logored font-semibold">
        {allHeadings[userLang == "en" ? "en" : "fr"]["level2"]}
      </h1>
      <p>
        {allText[userLang == "en" ? "en" : "fr"]["level2Text"]}
      </p>
      <div className="mt-5">
      <Switch className="h-full w-full checked:bg-logored"
        containerProps={{
      ...
      <h1 id="level3" className=" text-center pb-6 text-3xl text-logored font-semibold">
        {allHeadings[userLang == "en" ? "en" : "fr"]["level3"]}
      </h1>
      <p>
        {allText[userLang == "en" ? "en" : "fr"]["level3Text"]}
      </p>
      <div className="mt-5">
      <Switch className="h-full w-full checked:bg-logored"
        containerProps={{
